...
*/
	...
	$this->addAttributeMapping('leadtime_to_ship', 'leadtime-to-ship', false, false)->localized_name = 'sale-end-date';
	...
	$this->addAttributeMapping('feature_imgurl', 'main-offer-image', false, false)->localized_name = 'main-offer-image';
	for ($i = 1; $i < 6; $i++)
