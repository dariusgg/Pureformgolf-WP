  ...
  <div class="wrapper">
	<div class="frm-wrap-main">
		...
		<span id="error_msg"></span>
			...
			<input type="hidden" class="required" name="pure_package" id="pure_package" value="N/A" />
...
jQuery("#step2_back").hide();
jQuery("#div_step1").hide();
jQuery("#div_step2").show();
