...
( function( factory ) {
	...
	var defaults = {
		...
		open: false,
		map: { x: 's', y: 'l', z: 'h', a: 'a' },
		outputFormat: '', // Can be 'hsl', 'hsv', 'rgb', or 'hex' Alpha channel always included
		reset: 'clear',
		defaultValue: null, // Can be declared here, or will check for data attr
		closeOnBlur: true
	};
	...
	// $( function() {
	// 	$( '[data-huebert-init="true"]' ).huebert();
	// } );
