...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.2.0', __( 'WooCommerce PDF Product Vouchers', 'woocommerce-pdf-product-vouchers' ), __FILE__, 'init_woocommerce_pdf_product_vouchers', array( 'minimum_wc_version' => '2.3.6', 'backwards_compatible' => '4.2.0' ) );
...
class WC_PDF_Product_Vouchers extends SV_WC_Plugin {
	...
	private function add_file_permissions_notices() {
		...
		$message    = __( '%s: non-writable path %s%s%s detected, please fix directory permissions or voucher files may not be able to be generated.', 'woocommerce-pdf-product-vouchers' );
		$message_id = null;
