...
if($_REQUEST['action'] == 'process_user_form'  )
{
	...
	$pure_clubarr				= $_REQUEST['pure_club'];
	
	$pure_clubs = explode("::", $pure_clubarr);
	foreach($pure_clubs as $club)
	{
		if($club !="")
		$pure_club .= $pure_club!=""?', '.$club:$club;	
	}
	  
	$pure_city				= $_REQUEST['pure_city'];
	$pure_best_time			= $_REQUEST['pure_date']." ".$_REQUEST['pure_time'];
...
.v-link{font-size:14px; font-weight:800;text-transform: uppercase;}
								 ...
								 <table width="100%" cellspacing="0" cellpadding="5" border="0" class="email_text_cont">
									<tbody>
										...
										<tr><td align="left">Golf Link</td>
										  ...
										  <td colspan="2">'.$customer_comments.'</td>
										  </tr>
 ...
 <tr>
		...
		$headers .= "Bcc: ".$bcc."ajender210282@gmail.com,\n";
		$headers .= "Cc: ".$cc.",\n";
		$headers .= "Content-type: text/html; charset=iso-8859-1\n";
		 mail( "sunil8986@gmail.com", $subject, $body, $headers );
		 $to = 'william@webmarketers.com.au,rus@pureformgolf.com';
