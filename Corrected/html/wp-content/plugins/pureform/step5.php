		...
		<div class="in_form">
			<div class="in_form_inr">
				<h4>Tell us a bit about yourself </h4>
					...
					<input type="text" id="first_name" class="required" name="first_name" data_msg="Please enter first your name." value=""/>
					<div id="msg_first_name" class="error"></div>
					<label>Last Name</label>
					<input type="text" id="last_name" class="required" name="last_name" data_msg="Please enter your last name." value=""/>
					<div id="msg_last_name" class="error"></div>
					...
					<input type="text" id="customer_comments" name="customer_comments" value=""/>	
					<div id="msg_customer_comments" class="error"></div>
